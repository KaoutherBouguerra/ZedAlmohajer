...
public class LoginAsAssociationActivity extends AppCompatActivity {
    ...
    private static final String TAG = LoginAsAssociationActivity.class.getSimpleName();
    Button btnSignIn;
    ...
    private void LoginFirst(final String phone, final String password) {
        ...
        String url = Constants.LOGIN_URL_ASS;
        ...
        StringRequest LoginFirstRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        AlertDialogManager.showAlertDialog(LoginAsAssociationActivity.this,getResources().getString(R.string.app_name),msg,false,0);
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof AuthFailureError) {
                    ...
                    AlertDialogManager.showAlertDialog(LoginAsAssociationActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.authontiation),false,3);

                } else if (error instanceof ServerError) {
                    AlertDialogManager.showAlertDialog(LoginAsAssociationActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.servererror),false,3);
                } else if (error instanceof NetworkError) {
                    AlertDialogManager.showAlertDialog(LoginAsAssociationActivity.this,getResources().getString(R.string.networkerror),getResources().getString(R.string.networkerror),false,3);

                } else if (error instanceof ParseError) {
                } else if (error instanceof NoConnectionError) {
                } else if (error instanceof TimeoutError) {
                    AlertDialogManager.showAlertDialog(LoginAsAssociationActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.timeouterror),false,3);
                }
            }
        }) {
            /*     @Override
