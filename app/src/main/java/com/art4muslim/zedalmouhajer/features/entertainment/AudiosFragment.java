...
import com.art4muslim.zedalmouhajer.fragments.specific_association.AssociationNewsFragment;
...
public class AudiosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_audios, container, false);
    ...
    private void getSounds() {
        ...
        String url = Constants.GET_ALL_SOUNDS;
        //+KEY_API_TOKEN+"="+ BaseApplication.session.getAccessToken();

        Log.e(TAG, "get sounds url "+url);
        ...
        StringRequest hisRequest = new StringRequest(com.android.volley.Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Gson gson = new Gson();
                Log.e(TAG, "get sounds response === "+response.toString());
