...
import com.art4muslim.zedalmouhajer.adapters.FeedVideosAdapter;
...
public class VideosFragment extends Fragment {
    ...
    RecyclerView rvFeed;
    BaseApplication app;
    private FeedVideosAdapter feedAdapter;
    TextView txt_msg;
    ...
    private void setupFeed() {
        ...
        feedAdapter = new FeedVideosAdapter(getActivity(), videos);
    ...
    private void getVideos() {
        ...
        String url = Constants.GET_ALL_VIDEOS;
        //+KEY_API_TOKEN+"="+ BaseApplication.session.getAccessToken();

        Log.e(TAG, "get videos url "+url);
        ...
        StringRequest hisRequest = new StringRequest(com.android.volley.Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Gson gson = new Gson();
                Log.e(TAG, "get videos response === "+response.toString());
                ...
                try {
                    ...
                    for (int i = 0; i<resJsonObj.length();i++) {
                        ...
                        Video sound = gson.fromJson(String.valueOf(adrJsonObj), Video.class);
                        videos.add(sound);
                    }


                    feedAdapter.updateItems(true,videos);
