...
public class TermsAndConditionsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (app.getTermsText() == null)
            ...
            _txt_about.setText(Html.fromHtml(app.getTermsText()));
        }
        return v;
    }
