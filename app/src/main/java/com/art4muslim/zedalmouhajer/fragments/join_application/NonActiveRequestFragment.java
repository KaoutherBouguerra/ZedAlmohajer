 ...
 */
public class NonActiveRequestFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,ViewTreeObserver.OnScrollChangedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_non_active_request, container, false);
                ...
                try {
                    ...
                    if (resJsonObj.length() == 0){
                        ...
                        for (int i = 0; i < resJsonObj.length(); i++) {
                            ...
                            if (beneficiar.getActive().equals("0"))
